...
data = open("tau_py.txt",'w',encoding="utf-8")
data2 = open("tau_mat.txt",'w',encoding="utf-8")
...
print('parms = ',rbtdef.dynparms(), file=data)
print('parms = ',rbtdef.dynparms(), file=data2)
...
import sympy
from sympy import sin, cos, sign
...
print('tau1 = ',out[0].subs([(x,0) for x in subitems]), file=result) 
print('tau2 = ',out[1].subs([(x,0) for x in subitems]), file=result) 
print('tau3 = ',out[2].subs([(x,0) for x in subitems]), file=result) 
print('tau = ',out)